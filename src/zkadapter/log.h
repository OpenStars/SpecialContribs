...
//#define ZKCLIENT_NAMESPACE zkclient
//#define START_ZKCLIENT_NAMESPACE namespace ZKCLIENT_NAMESPACE {
//#define END_ZKCLIENT_NAMESPACE   }
//#define USING_ZKCLIENT_NAMESPACE using namespace ZKCLIENT_NAMESPACE;
...
#define LOG_INFO(logger, fmt, args...) printf(fmt,##args)
