...
class ZooKeeperConfig
{
    public:
		...
		static int defaultLeasedTimeout;
    private:
...
class ZKWatcherEvent
{
    public:
         ...
         * @param context the user specified context; possibly NULL
         */
        ZKWatcherEvent(int type, int state, const std::string &path, 
    ...
    : public ZKEventSource
{
    public:
         ...
         * @throw ZooKeeperException if the operation has failed
         */
        bool deleteNode(const std::string &path, bool recursive = false, int version = -1) 
            throw(ZooKeeperException);
         ...
         * @throw ZooKeeperException if the operation has failed
         */
        void setNodeData(const std::string &path, const std::string &value, int version = -1) 
            throw(ZooKeeperException);
         ...
         */
        static void validatePath(const std::string &path) throw(ZooKeeperException);
